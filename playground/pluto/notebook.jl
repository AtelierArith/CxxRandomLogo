...
# ╔═╡ 13b979f0-14f8-11ef-0806-e95dd0582b3d
begin
...
# ╔═╡ 732eebbf-056a-46ef-b0bc-7717e57898dd
begin
	run(`cmake -S ../../ -B ../../build`)
	run(`cmake --build ../../build --config Release`)
	const execpath = joinpath("../../build/bin/CxxRandomLogo")
	const H = 384
	const W = 384
end

# ╔═╡ 3c3cbb6b-902a-4348-845e-51fd681b501a
function generate_points()
	...
	for (i, li) in enumerate(split(c.output))
...
# ╔═╡ f45c91bf-8521-4614-b552-9a0bfe80103d
function draw()
...
# ╔═╡ 669956a2-4498-427d-9e5c-2c0390d01641
reshape([draw() for _ in 1:(3 * 3)], 3, 3)

# ╔═╡ 64f03ccd-fbb5-4f5c-8d20-e65dbb65e6cb
@time c = IOCapture.capture() do
	o = run(`$(execpath)`)
end
...
manifest_format = "2.0"
project_hash = "84b4c2ff32afc5fd5cd4c40cbb8763ecd7c42b15"
